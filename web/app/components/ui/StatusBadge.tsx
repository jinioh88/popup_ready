 ...
 *
 * **상태 외에 짧은 라벨 칩으로도 쓴다**(`ModularItemCard`의 규격·전력·대여료). 별도 Chip
 * 컴포넌트를 만들면 pill radius·패딩·글자 크기의 원천이 둘이 된다 — §7이 기본 4종을 넘기지
 * 말라는 이유가 그것이다. 다만 **정보를 색으로만 싣지 않는다**는 규칙은 그대로 적용된다.
 *
